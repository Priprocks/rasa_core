...
import rasa_core.dialogflow_emulator
...
class RasaCoreServer(object):
    ...
    def parse(self, request, sender_id):
        ...
        try:
            ...
            response['reply'] = reply[0]['text']
            if(self.emulator=='dialogflow'):
                response = dialogflow_emulator.DialogflowEmulator().normalise_response_json(response)
